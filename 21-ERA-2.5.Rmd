...
Capital can be based on [theoretical or practical](#era-2-5-change-in-cap) model
...
* Do we want increase or decrease *ROE*? 
...
Haven't done past exam questions for ERA 2
```
