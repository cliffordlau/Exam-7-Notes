...
1) Provides [stability](#era-2-5-sec-1)
    ...
    * [Based on reinsurance premium and expected recoveries](#era-2-5-stability-1)
        ...
        * Metrics \@ref(era-2-5-metrics-1) and \@ref(era-2-5-metrics-3)

    * [Amount of protection](#era-2-5-stability-2)
    
        * Metrics \@ref(era-2-5-metrics-3)

    * [Premium - loss](#era-2-5-stability-3)
    
        * Metrics \@ref(era-2-5-metrics-4), \@ref(era-2-5-metrics-5), \@ref(era-2-5-metrics-6) and \@ref(era-2-5-metrics-7)

    * [Efficient frontier](#era-2-5-stability-5)

2) Frees up [capital](#era-2-5-sec-2)

    * Cost of capital reduction metrics \@ref(coc-reduct-met-1) and \@ref(coc-reduct-met-2)
