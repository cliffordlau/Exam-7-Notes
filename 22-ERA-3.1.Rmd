...
1. [Startup: Staffing and Scope](#era-3-1-sec-1)
    ...
    * Issues to consider before begin implementing an internal risk model (IRM)

2. [IRM Parameter Development](#era-3-1-sec-2)

    * Issues and recommendations when selecting the parameters that are used in the IRM
...
* **Resource commitment**:  
Hiring staff, purchasing systmes, software, consultants
...
* Need to develop a systematic way to capture the expert opinion (product exptertise) from the following departments:
...
* Valiate and test over extended period
...
* Provide access to the output from the mdoel consistently and predictively
...
* Timeline ofr bonus pool

***Update frequency***

* Major updates should be no more than twice a year

* Minor upadtes can be handled by scaling
