...
[4 stage](#era-5-4-stage) of insurance business
...
* Need to us combined ratio or something as proxy for price

* Calculate and forecast predictor variables
...
Look at the different impact on [supply and demand](#era-5-supply-demand) under different scenarios
...
Haven't done past exam questions for ERA 4 and 5
```
