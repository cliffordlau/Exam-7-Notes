...
6) Business disruption and system failures
    ...
    * e.g. processing center downtime, system interuptions, flood
...
* e.g. Over accumulation of risk exposure (insufficient initial reserving or premature reserve release)
...
## Additional Perspectives {#add-pers-era-4-1}
...
Table: (\#tab:era-4-2-drizk) Categories of Strategic Risk
