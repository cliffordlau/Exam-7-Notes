...
* Know when we are working with *Ultimate* or *Reserve*

* Know when is the $GB$ [$MS$](#mack-2000-gb-mse) lower than $BF$

* Know the iterative form of BF and GB and it's extension Theorem \@ref(thm:GB-iterate)
...
* **Can't seem to reproduce the reserve formula...**
```
