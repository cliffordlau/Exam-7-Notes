...
1. Expected incremental losses are $\propto$ losses to date (prop. \@ref(prp:cl-ass-1))

2. Losses in each AY are $\perp\!\!\!\!\perp$ of the losses in other AYs (prop. \@ref(prp:cl-ass-2))

3. Variance of the incremental losses is $\propto$ losses reported to date (prop. \@ref(prp:cl-ass-3))
