...
* $\beta_d < 100\%$ most of the time, represents % paid (incurred) to date
```
...
* Each $\sigma_d = \sum_{i=d}^{10} \alpha_i$ where $\alpha_i \sim U(0,1)$
...
$C_{wd}$ has the same distribution as in LCL
