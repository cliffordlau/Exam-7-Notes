...
Know the different [risk categories](#ext-sys-risk)
...
[Internal benchmarking](#marshall-add-analysis), important to know the relationships and consistency, been heavily tested in the past
...
* For small data set, difficult to model away the external systemic risk 
    ...
    * Do not model away past episodes of systemic risk
...
Quantitative approach can provide in insight but we need to also consider possible emerging and potential future sources of external systemic risk
