...
Parameter risk is impact big companies more as their process risk is smaller \@ref(eq:era-3-2-cov-form)
...
* Use MLE working with infomration matrix \@ref(eq:info-matrix-era-3-2) and correlation matrix \@ref(eq:corr-matrix-era-3-2)
